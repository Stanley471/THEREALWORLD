        ...
        <section class="py-20 px-4 sm:px-6 lg:px-8" id="courses">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @php
                        $courses = [
                            ['title' => 'AI Automation', 'desc' => 'Build AI systems and sell them to online businesses. Teach anybody, even with limited technical knowledge, the skills required to build AI systems.', 'icon' => '🤖'],
                            ['title' => 'Business Mastery', 'desc' => 'Master the art of leadership and scaling operations to make more money. The Real World Business mastery training is about mastering diplomacy.', 'icon' => '💼'],
                            ['title' => 'Client Acquisition', 'desc' => 'Acquire, retain, and grow your client base with strategies that are as effective as they are explosive in the Client Acquisition + SM Campus.', 'icon' => '📱'],
                            ['title' => 'Content Creation + SM', 'desc' => 'In the age of technology, the value of videos and landing pages surpass the worth of real estate. Leverage digital assets and social media.', 'icon' => '📹'],
                            ['title' => 'Copywriting', 'desc' => 'Words are your warriors, and every sentence is a strategy. Master the craft of copywriting with us, and learn to turn prose into profit.', 'icon' => '✍️'],
                            ['title' => 'Crypto Altcoins', 'desc' => 'Our experts have been through every market cycle, every bull run, every crash—and they still come out on top. Learn altcoin trading.', 'icon' => '₿'],
                            ['title' => 'Crypto Investing', 'desc' => 'Real time information to identify trends and what influences the price of coins. Within the Cryptocurrency campus you have access to 155,000+ other students.', 'icon' => '📈'],
                            ['title' => 'Crypto Trading', 'desc' => 'Markets move fast. Learn to analyse charts, manage risk, and execute trades that compound into real wealth.', 'icon' => '💹'],
                            ['title' => 'E-Commerce', 'desc' => 'Imagine launching a store and instantly connecting with the global market by morning. Online commerce is your gateway to rapid retail success.', 'icon' => '🛍️'],
                            ['title' => 'Fitness', 'desc' => 'A strong body is a strong mind. Complete fitness campus including personal trainers and meal plans. Health is wealth.', 'icon' => '💪'],
                        ];
                    @endphp
